...
/**
 * The `ResetOnCloseGutterIcon` class is useful to render the gutter marker of a resettable environment property
 *
...
class ResetOnCloseGutterIcon : GutterIconRenderer() {
    ...
    /**
     * Method used to retrieve the reset icon
     *
     * @return the reset icon as [Icon]
     */
